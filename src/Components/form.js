    ...
    render() {
        ...
        return (
            <div style={{ marginTop: 100}} >
                <div className="card mt-5" style={{border:"none",backgroundColor:"black"}}>
                    <form className="card-body" onSubmit={this.onFormSubmit}  >
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input
                                ...
                                style={{ color: 'blue', width: 800 ,backgroundColor:'transparent'}} />
                        ...
                        <div className="form-group mb-3">
                            ...
                            <input
                                ...
                                className={error.password.length > 0 ? "is-invalid form-control" : "form-control"}
                                onChange={this.formObject}
                                style={{ color: 'blue', width: 800 ,backgroundColor:'transparent',height:100}} />
                        <div className="d-grid mt-3">
                                <button type="submit" style={{width:100,borderColor:'white',color:'black'}}>Send</button>
                        </div>
                    </form>
                </div>
            </div>
